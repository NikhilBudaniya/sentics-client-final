...
function NotifiDrawer() {
    ...
    return (
        <div className="w-full h-full">
            <div className={`border-0 h-[300px] border-red-400 rounded-t-2xl shadow-[0_0_10px_rgba(0,0,0,0.15)] ${Drawer? `translate-y-[0px]`:`translate-y-[255px]`} ease-in-out duration-300`}>
